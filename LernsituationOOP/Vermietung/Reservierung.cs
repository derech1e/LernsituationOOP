...
namespace LernsituationOOP.Vermietung
{
    public class Reservierung
    {
        ...
        [JsonConstructor]
        public Reservierung(Fahrzeug fahrzeug, Kunde kunde, DateTime reservierung_Start, DateTime reservierung_Ende,
            Prüfungsstatus prüfungsstatus = Prüfungsstatus.IN_BEARBEITUNG)
        {
            Fahrzeug = fahrzeug;
            Kunde = kunde;
        ...
        public Reservierung(Fahrzeug fahrzeug, Kunde kunde, DateTime reservierung_Start, DateTime reservierung_Ende,
            Prüfungsstatus prüfungsstatus, DateTime prüfungsdatum, Mitarbeiter mitarbeiter)
        {
            Fahrzeug = fahrzeug;
            Kunde = kunde;
            Reservierung_Start = reservierung_Start;
